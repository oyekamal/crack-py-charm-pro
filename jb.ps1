$idePaths = @(
    "C:\Users\$env:USERNAME\AppData\Local\Programs\PyCharm Professional\bin\pycharm64.exe",
    "C:\Users\$env:USERNAME\AppData\Local\Programs\CLion\bin\clion64.exe",
    "C:\Users\$env:USERNAME\AppData\Local\Programs\WebStorm\bin\webstorm64.exe"
